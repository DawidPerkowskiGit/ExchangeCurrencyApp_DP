...
public interface ExchangeRepository extends CrudRepository<Exchange, Integer> {
    ...
    List<Exchange> findAllByExchangeDateAndCurrencyOrderByExchangeDate(@Param("date") LocalDate date,
    ...
    Exchange findByExchangeDateAndCurrency_IsoName(@Param("date") LocalDate date,
                                                   @Param("currency") String currency);
